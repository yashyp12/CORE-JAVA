...
class StonePaper {
	...
	public static void main(String[] args) {
		...
		for (; ;) {
			...
			||(Responce1.equals("SCISSOR"))&&(Responce2.equals("STONE")))
			{
				System.out.println("USER WON");
			}else if((Responce1.equals("STONE"))&&(Responce2.equals("PAPER"))
			||(Responce1.equals("SCISSOR"))&&(Responce1.equals("STONE"))
			||(Responce1.equals("PAPER"))&&(Responce1.equals("SCISSOR"))
			||(Responce1.equals("SCISSOR"))&&(Responce1.equals("PAPER"))
