...
public class HappyNum {
    ...
    /*
     * A Happy Number is a number which, after repeatedly replacing it by the sum of the squares of its digits, eventually becomes 1.
     * 
     * A Sad (Unhappy) Number is one which never reaches 1 and instead falls into a loop (like 4, 16, 37, 58, 89, 145, 42, 20... then back to 4).
